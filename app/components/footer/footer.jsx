...
export default function Footer() {
  return (
    <div className="mb-6 mt-32">
      <div className="flex flex-col md:flex-row items-start justify-around gap-8 md:gap-0 px-4 md:px-0">
        <div className="flex flex-col md:flex-row w-full md:w-auto">
          <div className="p-3 mr-0 md:mr-10 mb-4 md:mb-0">
            <Image
              src="/logo.png"
              alt="Logo"
              width={100}
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mx-4 md:mx-32 mt-4 gap-4">
        ...
        <span className="text-grey-400 text-lg text-center">
